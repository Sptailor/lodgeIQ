...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Deep violet primary for bold modern feel
        primary: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 8px 24px rgba(0, 0, 0, 0.25)',
        'soft-2xl': '0 12px 32px rgba(0, 0, 0, 0.3)',
        'glow': '0 0 20px rgba(124, 58, 237, 0.3)',
        'glow-lg': '0 0 40px rgba(124, 58, 237, 0.4)',
        'glow-teal': '0 0 20px rgba(20, 184, 166, 0.3)',
        'glow-coral': '0 0 20px rgba(249, 115, 22, 0.3)',
        'neu': '8px 8px 16px rgba(0, 0, 0, 0.3), -4px -4px 12px rgba(255, 255, 255, 0.05)',
        'neu-inset': 'inset 4px 4px 8px rgba(0, 0, 0, 0.2), inset -2px -2px 6px rgba(255, 255, 255, 0.05)',
