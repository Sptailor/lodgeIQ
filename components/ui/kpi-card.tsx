...
const variantStyles = {
  default: {
    bg: 'bg-white dark:bg-gradient-to-br dark:from-neutral-800/40 dark:to-neutral-900/40 dark:backdrop-blur-xl',
    iconBg: 'bg-neutral-100 dark:bg-neutral-700/50',
    iconColor: 'text-neutral-600 dark:text-neutral-300',
    border: 'border-stone-200 dark:border-neutral-700/50',
    accentBar: 'bg-neutral-300 dark:bg-neutral-600',
  },
  success: {
    bg: 'bg-gradient-to-br from-emerald-50/50 to-white dark:from-emerald-950/20 dark:to-neutral-900/40 dark:backdrop-blur-xl',
  ...
  warning: {
    bg: 'bg-gradient-to-br from-amber-50/50 to-white dark:from-amber-950/20 dark:to-neutral-900/40 dark:backdrop-blur-xl',
  ...
  danger: {
    bg: 'bg-gradient-to-br from-red-50/50 to-white dark:from-red-950/20 dark:to-neutral-900/40 dark:backdrop-blur-xl',
  ...
  primary: {
    bg: 'bg-gradient-to-br from-accent-50/50 to-white dark:from-accent-950/20 dark:to-neutral-900/40 dark:backdrop-blur-xl',
    iconBg: 'bg-accent-100 dark:bg-accent-900/30',
    iconColor: 'text-accent-600 dark:text-accent-400',
    border: 'border-accent-200/60 dark:border-accent-800/30',
