 ...
 *
 * Professional dropdown using Radix UI primitives
 * Smooth animations, keyboard navigation, and polished styling
 */
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-accent-50 dark:focus:bg-accent-900/20',
      'data-[state=open]:bg-accent-50 dark:data-[state=open]:bg-accent-900/20',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-accent-50 dark:focus:bg-accent-900/20 focus:text-accent-700 dark:focus:text-accent-300',
      'active:scale-[0.98]',
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-4 w-4 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className="h-2 w-2 fill-accent-600" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-3 py-1.5 text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('my-1.5 h-px bg-neutral-200/80 dark:bg-neutral-700/80', className)}
    {...props}
  />
))
