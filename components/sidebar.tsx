  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-4 left-2 p-2.5 rounded-xl bg-white/40 dark:bg-neutral-900/40 backdrop-blur-xl border border-neutral-200/30 dark:border-neutral-700/30 shadow-md hover:bg-white/60 dark:hover:bg-neutral-900/60 hover:shadow-lg transition-all duration-300 touch-manipulation ${mobileMenuOpen ? 'z-[80]' : 'z-50'}`}
