...
export default async function HotelsPage() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl rounded-2xl p-5 sm:p-6 border-2 border-white/20 dark:border-neutral-700/50 shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex sm:flex-col items-center sm:items-end gap-2 sm:gap-1">
            ...
            <p className="text-3xl sm:text-4xl font-bold text-primary-600 dark:text-primary-400">{hotels.length}</p>
          </div>
        </div>
      </div>
